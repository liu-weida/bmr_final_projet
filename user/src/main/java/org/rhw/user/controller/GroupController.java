...
import org.rhw.user.dto.req.ShortLinkGroupSaveReqDTO;
...
public class GroupController {
     ...
     * 新增短链接分组
     */
    @PostMapping("/api/bmr_final/user/v1/group")
     ...
     * 查询短链接分组集合
     */
    @GetMapping("/api/bmr_final/user/v1/group")
     ...
     * 修改短链接分组名称
     */
    @PutMapping("/api/bmr_final/user/v1/group")
     ...
     * 删除短链接分组
     */
    @DeleteMapping("/api/bmr_final/user/v1/group")
     ...
     * 排序短链接分组
     */
    @PostMapping("/api/bmr_final/user/v1/group/sort")
